    ...
    <div class="container" style="margin-top:24px">
        <div class="row">
            <div class="list-group col-2">
                <a href="account_setting.php?action=1" class="list-group-item list-group-item-action" aria-current="true">
                    Thông tin tài khoản
                </a>
                <a href="account_setting.php?action=2" class="list-group-item list-group-item-action">Đổi mật khẩu</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary" value="change_pass" name="submit">Đổi mật khẩu</button>
                            </form>
